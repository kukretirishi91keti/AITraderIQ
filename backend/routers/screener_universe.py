...
STATIC_UNIVERSE = {
    ...
    # === India — full Nifty 50 + popular mid-caps ===
    'India': [
        ...
        'HINDALCO.NS', 'BEL.NS', 'HAL.NS', 'BHEL.NS', 'IRFC.NS',
        'PFC.NS', 'RECLTD.NS', 'IRCTC.NS', 'ZOMATO.NS', 'DMART.NS',
        'AMBUJACEM.NS', 'BANKBARODA.NS', 'PNB.NS', 'CANBK.NS', 'TRENT.NS',
        'BAJAJ-AUTO.NS',
    ],
