  ...
  currentCapabilities: [
    {
      ...
      description:
        'Live data with intelligent fallback. Dashboard never breaks even when APIs fail.',
      status: 'done',
      icon: '🛡️',
  ...
  caveats: [
    {
      ...
      icon: '⚠️',
      message:
        'yfinance is unofficial and may be rate-limited or blocked. Our LKG + MME fallback ensures graceful degradation.',
    },
    {
      type: 'Simulation Notice',
      icon: '🎮',
      message:
        "When showing 'SIMULATED' data quality, prices are mathematically modeled (GBM) but not actual market data.",
    },
    {
      type: 'Not Financial Advice',
      icon: '📋',
      message:
        'This platform is for educational and informational purposes only. Always consult a qualified financial advisor before making investment decisions.',
    },
    {
      type: 'Demo Limitations',
      icon: '🔧',
      message:
        "For production deployment with multiple workers, you'll need Redis-based rate limiting instead of the in-process semaphore.",
    },
  ],
};
  ...
  <div className="bg-white rounded-lg p-4 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
    <div className="flex items-start gap-3">
      ...
      <div className="flex-1">
        ...
        {item.technical && <p className="text-xs text-gray-400 mt-2 font-mono">{item.technical}</p>}
      </div>
    </div>
  </div>
);
...
const ProviderCard = ({ provider, isRecommended }) => (
  <div
    className={`bg-white rounded-lg p-4 border-2 ${isRecommended ? 'border-green-400 ring-2 ring-green-100' : 'border-gray-200'}`}
  >
    {isRecommended && (
    ...
    <div className="bg-gradient-to-br from-slate-50 to-blue-50 rounded-2xl p-6 shadow-lg">
      ...
      <div className="flex justify-between items-start mb-6">
        <div>
          ...
          <p className="text-gray-500 mt-1">Building the ultimate trading intelligence platform</p>
      ...
      {!isCollapsed && (
        <>
          ...
          {showCosts && (
            <CollapsibleSection
              title="Data Provider Upgrade Options"
              emoji="💰"
              defaultOpen={false}
            >
              <div className="bg-white rounded-lg p-4 mb-4">
                ...
                <p className="text-sm text-gray-500 mt-1">
                  Free but unofficial. Can be blocked anytime. Our fallback system ensures
                  continuity.
                </p>
              </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-blue-100 text-sm mt-1">
                  We&apos;re building this platform for traders like you. Let us know what would
                  help!
                </p>
              </div>
