      ...
      <div className="p-4 space-y-6">
        ...
        <section>
          ...
          <ul className="text-gray-300 text-sm mt-2 space-y-1 list-disc list-inside">
            <li>
              <span className="text-green-400">Oversold (RSI &lt; 30)</span> - Potential buy
              opportunities
            </li>
            <li>
              <span className="text-red-400">Overbought (RSI &gt; 70)</span> - Potential sell
              signals
            </li>
            <li>
              <span className="text-yellow-400">Neutral (30-70)</span> - No extreme conditions
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-300 text-sm">
            Ask questions about any stock. The AI considers your trading style and provides tailored
            advice. Try suggested prompts or type your own questions.
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="text-gray-300 text-sm space-y-1 list-disc list-inside">
            <li>
              <strong>RSI (14)</strong> - Momentum oscillator (0-100)
            </li>
            <li>
              <strong>SMA 20</strong> - 20-period Simple Moving Average
            </li>
            <li>
              <strong>EMA 12</strong> - 12-period Exponential Moving Average
            </li>
            <li>
              <strong>VWAP</strong> - Volume Weighted Average Price
            </li>
            <li>
              <strong>ATR</strong> - Average True Range (volatility)
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-300 text-sm">
            Click &quot;+ Watchlist&quot; to track stocks. Set price alerts with &quot;Set
            Alert&quot; - you&apos;ll be notified when conditions are met.
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="text-gray-300 text-sm space-y-1 list-disc list-inside">
            <li>
              <strong>Day</strong> - Intraday focus, quick trades
            </li>
            <li>
              <strong>Swing</strong> - Multi-day trends, support/resistance
            </li>
            <li>
              <strong>Position</strong> - Long-term, fundamental analysis
            </li>
            <li>
              <strong>Scalper</strong> - Micro-movements, rapid execution
            </li>
          </ul>
        </section>
